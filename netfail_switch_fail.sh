...
touch /home/freenet/netfail_active.txt
...
WHITELIST=/home/freenet/whitelist.txt
#
...
## Whitelist
#
$IPTABLES -t nat -A PREROUTING -d 192.168.2.250 -j RETURN
...
$IPTABLES -t nat -A PREROUTING -p tcp  -j DNAT --to-destination 192.168.2.250
$IPTABLES -t nat -A PREROUTING -p udp  -j DNAT --to-destination 192.168.2.250
