...
// IPN was confirmed as both genuine and VERIFIED
    if (!strcmp ($response, "VERIFIED"))
    {
                 ...
                 $sql = "SELECT pk_auction_account_id
                         ...
                         WHERE fk_auction_account_creditor_id=" . $_PAYPAL['item_number'] . " AND
                 ...
                 // account exists
                      {
                           $sql = "UPDATE " . AUCTION_ACCOUNT_TABLE . "
                                   SET auction_account_auction_amount = auction_account_auction_amount+" . $_PAYPAL['amount'] . ",
