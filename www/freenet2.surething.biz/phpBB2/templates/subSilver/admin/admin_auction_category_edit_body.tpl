...
<form action="{S_FORUM_ACTION}" method="post">
  <table cellpadding="4" cellspacing="1" border="0" class="forumline" align="center">
	...
	<tr> 
	  ...
	  <td class="row2"><input class="post" type="text" size="25" name="auction_category_title" value="{CAT_TITLE}" /></td>
	 </tr>
	<tr> 
	  <td class="row1">{L_CATEGORY_ICON}</td>
	  <td class="row2"><input class="post" type="text" size="25" name="auction_category_icon" value="{CAT_ICON}" /></td>
	 </tr>
