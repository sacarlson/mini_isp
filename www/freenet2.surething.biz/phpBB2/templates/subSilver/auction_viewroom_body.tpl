        <table align="center">
             <tr>
                  <td>
                       <img src="{AUCTION_ROOM_ICON}" />
                  </td>
                  <td>
                       <span class="forumlink">{AUCTION_ROOM_TITLE}</span>
                       <!-- BEGIN pagination_active -->
                       <span class="forumlink"> - {pagination_active.L_AUCTION_ROOM_PAGE_NUMBER}</span>
                       <!-- END pagination_active -->
                       <br>
                       <span class="gensmall">{AUCTION_ROOM_DESCRIPTION}</span>
                  </td>
             </tr>
        </table>
        <table>
             <tr>
                  <td>
                  <span class="gensmall">{L_AUCTION_ROOM_PAGE}</span>
                  <!-- BEGIN pagination_before -->
                       <a href="{pagination_before.U_AUCTION_ROOM_PAGE_NUMBER}" class="gensmall">{pagination_before.L_AUCTION_ROOM_PAGE_NUMBER}</a>
                  <!-- END pagination_before -->
                  <!-- BEGIN pagination_active -->
                       <span class="gensmall">{pagination_active.L_AUCTION_ROOM_PAGE_NUMBER}</span>
                  <!-- END pagination_active -->
                  <!-- BEGIN pagination_after -->
                       <a href="{pagination_after.U_AUCTION_ROOM_PAGE_NUMBER}" class="gensmall">{pagination_after.L_AUCTION_ROOM_PAGE_NUMBER}</a>
                  <!-- END pagination_after -->
                  </td>
             </tr>
        </table>
        <br>
        <table width="100%" class="forumline">
            ...
            <tr>
                 ...
                 <td class="row3" width="400"><span class="genmed">&nbsp;<a href="{offer_special.U_VIEW_AUCTION_OFFER}" class="genmed">{offer_special.AUCTION_OFFER_TITLE} {offer_special.AUCTION_OFFER_DIRECT_SELL}</a></span></td>
             ...
             <tr> 
                  ...
                  <td class="row1" width="400"><span class="genmed"><a href="{offer_on_top.U_VIEW_AUCTION_OFFER}" class="genmed">{offer_on_top.AUCTION_OFFER_TITLE} {offer_on_top.AUCTION_OFFER_DIRECT_SELL}</a></span></td>
             ...
             <tr> 
                  ...
                  <td class="row1" width="400"><span class="genmed"><a href="{offer.U_VIEW_AUCTION_OFFER}" class="genmed">{offer.AUCTION_OFFER_TITLE} {offer.AUCTION_OFFER_DIRECT_SELL}</a></span></td>
      ...
      <table width="100%">
             <tr>
                 <td align="left">
                      <a href={U_POST_NEW_OFFER}><img src="{NEW_OFFER_IMAGE}" border="0" /></a>
                 </td>
                  <td align="right">
                       <span class="gensmall">
            <a href="{U_AUCTION_SORT_PRICE_ASC}" title="{L_AUCTION_SORT_PRICE_ASC}" class="gensmall">{L_AUCTION_SORT_PRICE_ASC}</a><br>
            <a href="{U_AUCTION_SORT_PRICE_DESC}" title="{L_AUCTION_SORT_PRICE_DESC}" class="gensmall">{L_AUCTION_SORT_PRICE_DESC}</a><br>
            <a href="{U_AUCTION_SORT_PRICE_START_ASC}" title="{L_AUCTION_SORT_PRICE_START_ASC}" class="gensmall">{L_AUCTION_SORT_PRICE_START_ASC}</a><br>
            <a href="{U_AUCTION_SORT_PRICE_START_DESC}" title="{L_AUCTION_SORT_PRICE_START_DESC}" class="gensmall">{L_AUCTION_SORT_PRICE_START_DESC}</a><br>
            <a href="{U_AUCTION_SORT_TITLE_ASC}" title="{L_AUCTION_SORT_TITLE_ASC}" class="gensmall">{L_AUCTION_SORT_TITLE_ASC}</a><br>
            <a href="{U_AUCTION_SORT_TITLE_DESC}" title="{L_AUCTION_SORT_TITLE_DESC}" class="gensmall">{L_AUCTION_SORT_TITLE_DESC}</a><br>
            </span>
                  </td>
            </tr>
      </table>
